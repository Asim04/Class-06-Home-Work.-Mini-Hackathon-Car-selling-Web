...
import toyota from "../public/toyota.jpeg"
import Link from "next/link"

const toyotaFunction = () => {
  return (
    <div>
        <h1 className="text-5xl text-center my-12 ">Toyota Corolla Price in Pakistan, Images, Reviews, &Specs</h1>
        
        <div className="flex justify-center"><Image className="rounded-lg shadow-md" src={toyota} alt="car"/></div>
